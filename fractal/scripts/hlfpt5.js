...
var plane, top_plane_geometry, top_plane, sml_sphere, med_sphere, lrg_sphere, scene_box; // geometries
...
function setup() {
	...
	scene_box = new THREE.BoxGeometry(-100, -100, -100);
	var sky_texture = new THREE.TextureLoader().load('./texture/greenery.jpg');
	var sky_material = new THREE.MeshBasicMaterial({map: sky_texture});
	var sky_mesh = new THREE.Mesh(scene_box)
